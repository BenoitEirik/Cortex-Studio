...
<main>
  <div class="pt-[var(--var-header-height)] w-screen flex flex-col items-center bg-gray-900">
    <section class="p-4 max-w-7xl w-full">
      <button @click.prevent="router.go(-1)" class=" flex gap-4 items-end">
    ...
    <section class="p-4 max-w-7xl w-full flex flex-col gap-8 items-center">
      ...
      <div class="text-white">
        ...
        <p>
          Administration :<br>
          1 Bis route de Ballée,<br>
          53340 Chémeré-le-roi
        </p>
        <br>
        <p>
          INPI n° 3971155<br>
          RC : 48880276000014<br>
          TVA : FR25488802760<br>
          CEO : Alexandre Levionnois
        </p>
      </div>
    </section>
  </div>
...
useHead({
  title: 'Cortex Studio - Mentions légales',
  meta: [
